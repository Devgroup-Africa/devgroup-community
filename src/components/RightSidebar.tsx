...
const RightSidebar = () => {
  ...
  const topUsers = [...profiles].sort((a, b) => b.reputation - a.reputation).slice(0, 5);

  return (
    <aside className="hidden xl:block w-72 shrink-0">
      <div className="sticky top-20 space-y-5 max-h-[calc(100vh-6rem)] overflow-y-auto pr-1 scrollbar-thin">
